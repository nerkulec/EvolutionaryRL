...
def sac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        update_after=1000, update_every=50, act_noise=0.1, alpha=0.2, num_test_episodes=10, max_ep_len=1000, 
    ...
    def get_action(o, actor, deterministic=False):
        return actor.act(torch.as_tensor(o, dtype=torch.float32),
        ...
        for t in range(total_steps):
            ...
            if t > start_steps:
                if actor_num == -1:
                    ...
                    a = get_action(o, actors[actor_num], True)
            else:
            ...
            if d or (ep_len == env._max_episode_steps):
                ...
                if(actor_num >= len(actors)):
                    ...
                    evo_num += 1
                    if evo_num % rl_actor_copy_every:
